...
export class CapharnaumActorSheet extends ActorSheet {
  ...
  get template() {
    switch (this.actor.data.type) {
      ...
      case "Valiant Captain":
        return `systems/capharnaum/templates/actor/actor-valiant-captain-sheet.html`;
        break;

      case "Babouches Dragger":
        return `systems/capharnaum/templates/actor/actor-babouches-dragger-sheet.html`;
        break;
  ...
  getData() {
    ...
    // Prepare character data and items.
    if (actorData.type == 'Valiant Captain') {
      this._prepareItems(context);
      this._prepareCharacterData(context);
    }

    // Prepare NPC data and items.
    if (actorData.type == 'Babouches Dragger') {
      this._prepareItems(context);
      this._prepareCharacterData(context);
    }
